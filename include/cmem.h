...
#define CMEM_HISTOGRAM_BUCKETS 16
    ...
    typedef enum
    {
        ...
        MP_FLAG_TRACK_LOCATIONS =
            (1 << 5), /**< Record file, line, function & backtrace for allocs */
     ...
     */
    typedef void (*mp_event_callback_t)(memory_pool_t* pool, mp_event_type_t event, void* ptr,
     ...
     * @param user_data Optional user data passed to the callback
     */
    typedef void (*mp_watermark_callback_t)(memory_pool_t* pool, bool is_high_watermark,
                                            size_t current_bytes, size_t limit_bytes,
                                            void* user_data);
     ...
     */
    void* mp_alloc_loc(memory_pool_t* pool, size_t size, const char* file, int line,
                       const char* func);
     ...
     */
    void* mp_realloc_loc(memory_pool_t* pool, void* ptr, size_t new_size, const char* file,
     ...
     * @return true on success
     */
    bool mp_diff_snapshots(const char* snapshot_a_path, const char* snapshot_b_path,
     ...
     */
    bool mp_event_log_record(mp_event_log_t* log, mp_event_type_t event_type, void* ptr,
                             size_t size);
