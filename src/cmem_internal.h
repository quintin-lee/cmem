...
extern bool tlsf_try_inplace_expand(memory_pool_t* pool, mp_block_header_t* header,
                                    size_t new_size);
...
extern bool mp_diff_snapshots(const char* snapshot_a_path, const char* snapshot_b_path,
                              char* out_report, size_t max_len);
...
extern bool mp_event_log_record(mp_event_log_t* log, mp_event_type_t event_type, void* ptr,
                                size_t size);
...
extern void mp_set_event_callback(memory_pool_t* pool, mp_event_callback_t callback,
                                  void* user_data);
extern void mp_set_watermark_callback(memory_pool_t* pool, double high_ratio, double low_ratio,
                                      mp_watermark_callback_t cb, void* user_data);
extern void check_watermark_after_change(memory_pool_t* pool);
extern void mp_set_arena_quota(memory_pool_t* pool, size_t quota_bytes, mp_watermark_callback_t cb,
                               void* user_data);
...
extern void mp_set_auto_compact(memory_pool_t* pool, bool enable, double pressure_threshold,
...
extern void mp_set_eviction_callback(memory_pool_t* pool, mp_watermark_callback_t cb,
                                     void* user_data);
...
extern void mp_set_error_recovery_callback(memory_pool_t* pool, mp_watermark_callback_t cb,
                                           void* user_data);
