...
int main()
{
    ...
    memory_pool_t *scene_arena =
        mp_create_child(root_pool, 1024 * 1024, MP_FLAG_DEFAULT, "SceneNodeArena");
    memory_pool_t *ast_arena =
        mp_create_child(root_pool, 512 * 1024, MP_FLAG_DEFAULT, "ASTCompilerArena");
    memory_pool_t *net_arena =
        mp_create_child(root_pool, 512 * 1024, MP_FLAG_DEFAULT, "NetworkPacketArena");
